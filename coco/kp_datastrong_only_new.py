...
def kp_data_strong( src_json, image_path, save_json_path, save_image_path, rotates=[90,180,270] ):
    ...
    with open( src_json, 'r' ) as src_f:
        ...
        for index, rotate in enumerate(rotates):
            ...
            json_data_rotate['imageHeight'] = rotate_image_w
...
def main(args):
    ...
    for json_index, json_file in enumerate( json_files ):
        kp_data_strong(src_json=json_file, 
                    image_path=args.input_image_path, 
                    save_json_path=args.output_annotation_path, 
                    save_image_path=args.output_image_path,
                    rotates = args.rotates)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_annotation_path', type=str, default='/home/fisun/dataset/public/coco_ds/single_kp_ds_json_val2017_json',   help='output data strong annotations path')
    parser.add_argument('--output_image_path',      type=str, default='/home/fisun/dataset/public/coco_ds/single_kp_ds_json_val2017_image',  help='output data strong image path')
    parser.add_argument('--rotates',                type=int, default=[90,270],        help='output data strong image path')
