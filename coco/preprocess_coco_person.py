...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_annotation_file', type=str, default='/home/fisun/dataset/public/coco_ds/single_kp_ds_all_sample/val2017/person_keypoints_dsall_val2017.json', help='Path to input annotation file')
    parser.add_argument('--output_annotation_file', type=str, default='/home/fisun/dataset/public/coco_ds/single_kp_ds_all_sample/val2017/person_keypoints18_dsall_val2017.json', help='Path to save annotation file')
    ...
    print('Preprocessing...')
    proc_label=['person','fall']
    for index, proc_l in enumerate(proc_label):
        cat = get_cat(data, proc_l)
        cat_id = cat['id']
