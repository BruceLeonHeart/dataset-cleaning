...
def proc_json2train_list( single_json, save_path, kp_names, classify, lass_kp_num ):
...
def main(args):
    ...
    if len(json_files) > 0:
        ...
        for index, json_file in enumerate(json_files):
            proc_json2train_list( json_file, args.save_path, names, args.classify, args.lass_kpnum )
...
if __name__ == "__main__":
    ...
    parser.add_argument('--classify',        type=int, default=0, help='classify index 0 normail 1 fall')
